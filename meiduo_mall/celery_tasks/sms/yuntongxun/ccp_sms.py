...
_accountSid = '8a216da87e7baef8017f2c232c951a30'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = '9c570c6fcb144c5caec6b78a0cdc4691'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '8a216da87e7baef8017f2c232e071a37'
...
if __name__ == '__main__':
    # 注意： 测试的短信模板编号为1
    CCP().send_template_sms('18694098079', ['123456', 5], 1)
